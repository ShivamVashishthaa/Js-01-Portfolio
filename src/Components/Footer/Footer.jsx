...
function Footer() {
  return (
    <footer className='grid grid-cols-1 w-full px-5 py-5 bg-gradient-to-b from-white to-orange-400 dark:bg-gradient-to-b from-white to-slate-500 md:grid-cols-2 align-text-bottom bottom-0'>
