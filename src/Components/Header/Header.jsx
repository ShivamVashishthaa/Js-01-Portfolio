...
import Nav_slide from "./Nav_slide";
...
function Header() {
  ...
  return (
    <>
      <header
        className="flex justify-between  items-center px-4 lg:px-11 py-4"
        id="header"
      >
        <div className="lg:hidden w-1 ">
          ...
          {!nav && <Nav_slide theme={theme} hiddenNav={hiddenNav} />}
        </div>
        <div className="">
        ...
        <nav className="hidden lg:block text-base font-bold">
          <ul className="flex gap-5">
            <li className="hover:underline hover:underline-offset-4 decoration-2">
              <Link className="inline-block hover:scale-105 " to="/">
                Home
              </Link>
            </li>
            <li className="hover:underline hover:underline-offset-4 decoration-2">
              <Link className="inline-block hover:scale-105 " to="about">
                About
              </Link>
            </li>
            <li className="hover:underline hover:underline-offset-4 decoration-2">
              <Link className="inline-block hover:scale-105 " to="skills">
                Skill
              </Link>
            </li>
            <li className="hover:underline hover:underline-offset-4 decoration-2">
              <Link className="inline-block hover:scale-105 " to="project">
                Project
              </Link>
            </li>
            <li className=" hover:underline hover:underline-offset-4 decoration-2 ">
              <Link className="inline-block hover:scale-105 " to="contact">
                Contact
              </Link>
            </li>
          </ul>
